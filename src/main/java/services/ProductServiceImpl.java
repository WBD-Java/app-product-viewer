...
public class ProductServiceImpl implements ProductService{
    ...
    static final String DB_URL = "jdbc:mysql://localhost:3306/awesome_business";
    ...
    public List<Product> findAll() throws ClassNotFoundException, SQLException {
        Class.forName(JDBC_DRIVER); /* Nạp JDBC Driver */

        Connection conn = null; /* Tạo đối tượng connection */
        Statement stmt = null;
